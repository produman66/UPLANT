...
public class Cartochka5ViewHolder extends RecyclerView.ViewHolder{
    private final TextView wordItemView;
    private final TextView wordDesk;
    private final TextView zag;
    private final ImageView image;

    public Cartochka5ViewHolder(@NonNull View itemView) {
        super(itemView);
