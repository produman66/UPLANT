...
public class Cartochka4Adapter extends ListAdapter<MyPlant, Cartochka4ViewHolder> {

    public Cartochka4Adapter(@NonNull DiffUtil.ItemCallback<MyPlant> diffCallback) {
        super(diffCallback);
    }
    ...
    public void onBindViewHolder(@NonNull Cartochka4ViewHolder holder, int position) {
        ...
        holder.bind1(current.getmWord1(), current.getNameimage(), current.getUdobr());
    }
