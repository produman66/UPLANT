...
public class Cartochka6ViewHolder extends RecyclerView.ViewHolder{
    private final TextView wordItemView;
    private final TextView wordDesk;
    private final TextView zag;
    private final ImageView image;

    public Cartochka6ViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public static Cartochka6ViewHolder create1(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_image, parent, false);
        return new Cartochka6ViewHolder(view);
    }
}
