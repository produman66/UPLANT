...
public class Cartochka3ViewHolder extends RecyclerView.ViewHolder{
    private final TextView wordItemView;
    private final TextView wordDesk;
    private final TextView zag;
    private final ImageView image;

    public Cartochka3ViewHolder(@NonNull View itemView) {
        super(itemView);
