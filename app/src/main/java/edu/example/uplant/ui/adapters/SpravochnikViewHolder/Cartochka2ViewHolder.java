...
public class Cartochka2ViewHolder extends RecyclerView.ViewHolder{
    private final TextView wordItemView;
    private final TextView wordDesk;
    private final ImageView image;
    private final TextView zag;

    public Cartochka2ViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public static Cartochka2ViewHolder create1(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_image, parent, false);
        return new Cartochka2ViewHolder(view);
    }
}
