...
public class PlantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public PlantViewHolder(@NonNull View itemView, CustomerClickListener listener) {
        super(itemView);
    ...
    public static PlantViewHolder create(ViewGroup parent, CustomerClickListener listener) {
