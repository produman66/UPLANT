...
public class Cartochka10ViewHolder extends RecyclerView.ViewHolder{
    private final TextView wordItemView;
    private final TextView wordDesk;
    private final TextView zag;
    private final ImageView image;

    public Cartochka10ViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public static Cartochka10ViewHolder create1(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_image, parent, false);
        return new Cartochka10ViewHolder(view);
    }
}
